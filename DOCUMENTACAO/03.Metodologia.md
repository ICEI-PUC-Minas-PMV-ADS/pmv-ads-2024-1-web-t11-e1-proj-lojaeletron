...
o Scrum é um framework (arcabouço) dentro do qual pessoas podem tratar e resolver problemas complexos enquanto constroem produtos de forma criativa e eficiente, com o mais alto valor possível (Guia do Scrum, 2017) (Manisfeto). ref .https://ai-learn.it/wp-content/uploads/2019/03/03_ManifestoofAgileSoftwareDevelopment-1.pdf
...
<ul>
  ...
  <li>Product Owner: Arthur Isidoro </li>
...
O software de gestao escolhido foi o Trello, o quadro kanban do grupo esta tambem disponivel no GitHub no link é apresentado, no estado atual, na figura abaixo:

![Kanban](/DOCUMENTACAO/trello.png)
...
![Kanban](/DOCUMENTACAO/etiquetas.png)
...
[codigo-fonte](https://github.com/ICEI-PUC-Minas-PMV-ADS/pmv-ads-2024-1-e1-proj-web-t11-pmv-ads-2024-1-web-t11-e1-proj-lojaeletron.git). 
