...
![Diagrama](/documentos/imgs/conceito.png)
...
![Estrutura](/documentos/imgs/estrutura.png)
...
![homepage](/documentos/imgs/pagina_inicial.png)
...
![livros](/documentos/imgs/compras.png)
...
![tutoria (1)](/documentos/imgs/detalhes.png)
...
![tutoria (1)](/documentos/imgs/carrinho.png)
...
<p>A tela de finalização de compras exibi detalhes do pedido, endereço dentro da conta, informações em gerais, além de possíveis atalhos para outras paginas de navegação, caso o usuário 1deseje finalizar o pedido em outro momento.</p>
  
  ![cadastro](/documentos/imgs/finalizar.png)
